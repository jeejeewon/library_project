...
<html>
<head>
	<title>이벤트 상세페이지 - eventInfo.jsp</title>
	<style>
		/* 기본 리셋 */
		* {
			margin: 0;
	...
	<div class="center-wrapper">
		...
		<div class="paging">
			...
			<c:if test="${getPreBoardId > 0}">
			    <form action="${pageContext.request.contextPath}/bbs/eventInfo.do" method="get">
		...
		<div class="board-info-bottom">
			<div class="board-info-bottom-left">
				<a href="${contextPath}/bbs/eventModifyForm.do?boardId=${board.boardId}">수정</a>
	    ...
	    function fn_remove_board(url, boardId) {
	        ...
	        .then(data => {
	            ...
	            if (data.result === 'success') {
	                ...
	                // 삭제 후 리다이렉트할 URL로 이동 (기본값은 이벤트 목록 페이지)
