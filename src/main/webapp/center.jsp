...
<div class="center_wrap">
			...
			<div class="main-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<img src="https://library.korea.ac.kr/wp-content/uploads/2021/04/main_lib_20210422.jpg">
					</div>
					<div class="swiper-slide">
						<img src="https://library.korea.ac.kr/wp-content/uploads/2021/04/%EB%A6%AC%EC%94%BD%ED%81%AC%EC%8A%A4%ED%8E%98%EC%9D%B4%EC%8A%A41_%ED%81%AC%EA%B8%B0%EB%B3%80%EA%B2%BD-2.jpg">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="main-notice-and-Video">
			...
			<div class="swiper-wrapper">
				<c:if test="${not empty eventBannerList}"> 
					<c:forEach var="banner" items="${eventBannerList}">
						<div class="swiper-slide">
							<img src="${pageContext.request.contextPath}/board/board_file_repo/${banner.boardId}/${banner.bannerImg}" alt="${banner.title} 배너 이미지">
						</div>
					</c:forEach>
				</c:if>
			</div>
			...
			<ul> 
				<c:if test="${not empty noticeList}"> 
					<c:forEach var="notice" items="${noticeList}">
						...
						<span><fmt:formatDate value="${notice.createdAt}" pattern="MM-dd"/></span>
						</li>
					</c:forEach>
			</c:if>
		...
		<div class="main-Video">
			<iframe width="100%" height="270px" src="https://www.youtube.com/embed/VHxusqT1dXo?si=8aN0XRzafHIAIuKP&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
		</div>
	</div>
</div>
