...
public class RentalVo {
    ...
    public Timestamp getReturnDue() { return returnDue; }
    public void setReturnDue(Timestamp returnDue) { this.returnDue = returnDue; }
    ...
    public int getReturnState() { return returnState; }
    public void setReturnState(int returnState) { this.returnState = returnState; }
